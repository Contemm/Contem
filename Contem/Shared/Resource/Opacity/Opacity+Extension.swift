...
extension CGFloat {
    ...
    /// 0.15 - 약한 투명도
    static let opacity15: CGFloat = 0.15
...
extension Double {
    /// 0.1 - 매우 약한 투명도
    static let opacity10: Double = 0.1
    
    /// 0.15 - 약한 투명도
    static let opacity15: Double = 0.15
    
    /// 0.3 - 중간 투명도
    static let opacity30: Double = 0.3
    
    /// 0.5 - 반투명
    static let opacity50: Double = 0.5
    
    /// 0.8 - 강한 반투명
    static let opacity80: Double = 0.8
}
...
extension View {
    /// 매우 약한 투명도 적용 (0.1)
    func opacityVeryLight() -> some View {
        self.opacity(.opacity10)
    }
    
    /// 약한 투명도 적용 (0.15)
    func opacityLight() -> some View {
        self.opacity(.opacity15)
    }
    
    /// 중간 투명도 적용 (0.3)
    func opacityMedium() -> some View {
        self.opacity(.opacity30)
    }
    
    /// 반투명 적용 (0.5)
    func opacityHalf() -> some View {
        self.opacity(.opacity50)
    }
    
    /// 강한 반투명 적용 (0.8)
    func opacityStrong() -> some View {
...
extension Color {
    ...
    func withOpacityVeryLight() -> Color {
        self.opacity(.opacity10)
    }
    
    /// 현재 색상에 약한 투명도 적용 (0.15)
    func withOpacityLight() -> Color {
        self.opacity(.opacity15)
    }
    
    /// 현재 색상에 중간 투명도 적용 (0.3)
    func withOpacityMedium() -> Color {
        self.opacity(.opacity30)
    }
    
    /// 현재 색상에 반투명 적용 (0.5)
    func withOpacityHalf() -> Color {
        self.opacity(.opacity50)
    }
    
    /// 현재 색상에 강한 반투명 적용 (0.8)
    func withOpacityStrong() -> Color {
        self.opacity(.opacity80)
    }
}
