...
extension View {
    /// 기본 패딩 (16pt)
    public func paddingDefault() -> some View {
        padding(.spacing16)
    }

    /// 화면 패딩 (20pt)
    public func paddingScreen() -> some View {
        padding(.spacing20)
    }

    /// 수평 기본 패딩 (16pt)
    public func paddingHorizontalDefault() -> some View {
        padding(.horizontal, .spacing16)
    }

    /// 수직 기본 패딩 (16pt)
    public func paddingVerticalDefault() -> some View {
